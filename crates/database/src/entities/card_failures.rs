...
/// A failing card and its backoff state. Unique on (`side`, `href`), enforced
/// by the migration's index. `href` and `uid` identify a contact: never log a
/// `Model`.
#[sea_orm::model]
#[derive(Clone, Debug, PartialEq, Eq, DeriveEntityModel, Serialize, Deserialize)]
#[sea_orm(table_name = "card_failures")]
pub struct Model {
    #[sea_orm(primary_key)]
    pub id: i64,
    pub version: i64,
